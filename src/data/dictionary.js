const dictionary = [
    ...
    {
        'Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. ':
            'The simplest way to define a component is to write a JavaScript function. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. Самый простой способ определить компонент это написать дважваскрипт функцию. '
    },
    {
