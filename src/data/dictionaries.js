...
const dictionaries: dictSet = {
  ...
  dictionary2: [
...

    {
      ...
      eng: 'Handling events with React elements is very similar to handling events on DOM elements',
    },
    { rus: 'Есть некоторые синтаксические различия.', eng: 'There are some syntactic differences' },
    {
    ...
    },
    {
      ...
      eng: 'This is not React-specific behavior; it is a part of how functions work in JavaScript.',
    },
    {
    ...
    },
    {
      ...
      eng: 'Inside a loop it is common to want to pass an extra parameter to an event handler.',
    },
